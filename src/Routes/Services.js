...
function Services() {
  return (
    <div  className='content'>
      ...
      {/* <div className='content-box'>
      <h3>Certifications and Credentials:</h3> Many technical training programs offer the opportunity for students to earn industry-recognized certifications or credentials. These certifications can significantly enhance a student's job prospects and demonstrate their expertise to potential employers.
      </div> */}
